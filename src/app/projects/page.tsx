...
const projectImages: Record<string, string> = {
  ...
  'Facebook Clone': '/assets/images/project-7.png',
  'Contact Manager': '/assets/images/cm.png',
  'Restaurant Website': '/assets/images/project5.png',
