export default function Head() {
  return (
    <>
      ...
      <link rel="mask-icon" href="/assets/images/logo.svg" color="#1976d2" />
      ...
      <meta name="apple-mobile-web-app-title" content="Ajit Kushwaha - ajitReact" />
      <meta name="application-name" content="Ajit Kushwaha Portfolio - ajitReact" />
      ...
      <meta property="article:author" content="Ajit Kushwaha" />
      <meta property="article:publisher" content="ajitReact" />
      <meta property="article:section" content="Technology" />
      <meta property="article:tag" content="React, JavaScript, Web Development, MERN Stack" />

      {/* Business Schema Meta Tags */}
      <meta property="business:contact_data:street_address" content="Ahmedabad, Gujarat, India" />
